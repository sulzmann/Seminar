...
#### Verwendung von Concurrency in Go (Projekt)
...
#### Verwendung von Generics in Go (Projekt)
...
#### AdvocateGo: Dynamische Concurrency Analysen für Go (Projekt)
...
#### Smarter Regular Expression Matching: From Theory to Tools
...
#### Tracer for Go events including non-atomic reads/writes based on ThreadSanitizer (TSan)
