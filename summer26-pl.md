...
* Making ambiguous ideas precise
* Designing abstractions
* Managing complexity
* Ensuring correctness


Therefore, there is no need to worry. AI will not replace us.
Copilot is just a tool.
AI tools empower programmers to become more productive. Good programming skills and a solid understanding of programming languages is therefore more important than ever.

Keep in mind:

* AI generates code
* AI does not generate specifications
* AI does not understand intent
* AI does not prove correctness
* AI does not manage responsibility
...
The first seminar topics are linked to an academic paper.
The focus is more on theory. Read the paper and tell us what you think about the paper.
The remaining topics cover a more general area (not linked to a single paper).
...
You should have some familiarity with at least one of these languages.
