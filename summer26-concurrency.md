# Seminar Summer 26: Program Analysis with a focus on Concurrency and Go
...
## T6: [RELAY: Static Race Detection on Millions of Lines of Code](https://cseweb.ucsd.edu/~lerner/papers/relay.pdf)
...
There appears to be a Go variant: [Chronos - A static race detector for the go language](https://github.com/amit-davidson/Chronos)

## T7: [LOCKSMITH: Practical Static Race Detection for C](https://users.ics.forth.gr/~polyvios/toplas10.pdf)
...
## T8: [RacerF: Lightweight Static Data Race Detection for C Code](https://drops.dagstuhl.de/storage/00lipics/lipics-vol333-ecoop2025/LIPIcs.ECOOP.2025.37/LIPIcs.ECOOP.2025.37.pdf)
...
## T9: [Sound Static Data Race Verification for C: Is the Race Lost?](https://dl.acm.org/doi/pdf/10.1145/3732933)
